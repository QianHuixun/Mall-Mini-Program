...
@Data
public class JdRefundOrderDetails
{
    ...
    {
        if(courierType != null)
            return courierType.getName();
        return "京东上门取件";
    }
    
    @Schema(description = "取件-省")
    private String pro;
    
    @Schema(description = "取件-市")
    private String city;
    
    @Schema(description = "取件-区")
    private String area;
    
    @Schema(description = "取件-街道")
    private String town;
    
    @Schema(description = "取件-地址")
    private String pickupAddr;
    
    @Schema(description = "取件-寄件人")
    private String name;
    
    @Schema(description = "取件-寄件人电话")
    private String mobile;
    
    @Schema(description = "收货-省")
    private String receiptPro;
    
    @Schema(description = "收货-市")
    private String receiptCity;
    
    @Schema(description = "收货-区")
    private String receiptArea;
    
    @Schema(description = "收货-街道")
    private String receiptTown;
    
    @Schema(description = "收货-收货地址")
    private String receiptAddr;
    
    @Schema(description = "收货-收货名称")
    private String receiptName;
    
    @Schema(description = "收货-收货人手机")
    private String receiptMobile;
    
    
    @Schema(description = "退换货物流-快递公司")
    private String courierCompany;
    
    @Schema(description = "退换货物流-快递单号")
