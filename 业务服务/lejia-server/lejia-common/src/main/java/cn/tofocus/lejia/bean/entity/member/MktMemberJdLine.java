...
//@Data
//@Entity
//@Schema(description = "会员京东账户明细")
//@Table(name = "mkt_member_jd_line")
//@FieldNameConstants(innerTypeName = "F")
//public class MktMemberJdLine implements HasPkey<Long>
//{
//    @Id
//    @Column
//    @Schema(description = "主键")
//    @AutoRedisID(domain = "zyysc", sequence = "mkt_member_jd_line")
//    private Long pkey;
//
...
//    private JdOperationType operationType;
//
