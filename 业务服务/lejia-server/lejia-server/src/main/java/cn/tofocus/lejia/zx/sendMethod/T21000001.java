...
//        String httpsUrl = "https://202.108.57.27:30466/dsgj/";
        ...
        try {
            ...
            request.setMCHNT_USER_ID("test5");//平台商户自己记录的用户编号
            request.setUSER_TYPE("1");
            request.setUSER_NM("J00024000000002"); // 用户姓名
            request.setUSER_ROLE("004001"); // 角色编号
            request.setSIGN_TYPE("00");//签约类型  00:自主注册 01:迁移注册
            request.setUSER_ID_TYPE("01"); // 01-个人身份证
            request.setUSER_ID_NO("371329198804011179");
            request.setUSER_PHONE("15096230421");
            request.setCORP_NM("在市谋");
//            request.setCORP_ID_NO("123456"); // 企业法人身份证号码
            request.setUSER_ADD("北京市青年路");
            request.setREQ_RESERVED("123456");//发起方保留域      
//            request.setCORP_ID_TYPE("");
            
            //实体对象转换为XML
            xtreamData.alias("ROOT", T21000001Request.class);
...
//            String resStr = "<?xml version=\"1.0\" encoding=\"utf-8\"?><ROOT><RSP_CODE>00000</RSP_CODE><REQ_SSN>BECP20180327163652919JM296TX4D4ZIY69OQ8K</REQ_SSN><MEM_ID>H00000700000001</MEM_ID><SIGN_INFO></SIGN_INFO></ROOT>";
            resStr = resStr.replace("ROOT", T21000001Response.class.getName());

            //把xml为转换为实体对象
            T21000001Response resData =
                    (T21000001Response) Utils.getObjectFromXML(resStr, T21000001Response.class);
