...
//        String httpsUrl = "https://202.108.57.27:30466/dsgj";
        ...
        try
        {
            ...
            request.setFILE_NAME("J0002400000000010010012021121401");
            //            request.setREQ_RESERVED("2");
            
            //实体对象转换为XML
            xtreamData.alias("ROOT", T21000012Request.class);
            ...
            resStr = resStr.replace("ROOT", T21000012Response.class.getName());
            
          //把xml为转换为实体对象
            T21000012Response resData = (T21000012Response)Utils.getObjectFromXML(resStr, T21000012Response.class);
