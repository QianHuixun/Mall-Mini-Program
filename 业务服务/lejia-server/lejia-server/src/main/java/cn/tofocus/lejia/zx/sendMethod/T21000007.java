...
//        String httpsUrl = "https://22.5.65.150:30466/dsgj";
        ...
        try {
            ...
            request.setFILE_NAME("J0002400000000010011012021112501");
            request.setFILE_TYPE("101");
            request.setSETTLE_DT("20211126");
            request.setTRANS_TYPE("MSG");
//            request.setREQ_RESERVED("2");
            
            //实体对象转换为XML
            xtreamData.alias("ROOT", T21000007Request.class);
...
//            String resStr = "<?xml version=\"1.0\" encoding=\"utf-8\"?><ROOT><RSP_CODE>00000</RSP_CODE><REQ_SSN>BECP20180327163652919JM296TX4D4ZIY69OQ8K</REQ_SSN><MEM_ID>H00000700000001</MEM_ID><SIGN_INFO></SIGN_INFO></ROOT>";
            resStr = resStr.replace("ROOT", T21000007Response.class.getName());

            //把xml为转换为实体对象
            T21000007Response resData =
                    (T21000007Response) Utils.getObjectFromXML(resStr, T21000007Response.class);
