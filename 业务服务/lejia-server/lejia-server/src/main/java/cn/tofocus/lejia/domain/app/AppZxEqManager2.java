...
public class AppZxEqManager2
{
    ...
    static
    {
        ...
        private static final String PTNRTESTCER = ROOTPATH + "/config/PTNR/PTNRtest.cer";
        
        /** https私钥库*/
        private static final String KEYSTORE_PATH = ROOTPATH + "/config/PTNR/df_test.keystore";
        
        /** https信任库*/
        private static final String TRUSTSTORE_PATH = ROOTPATH + "/config/PTNR/df_test.keystore";
...
//        System.out.println(new String(decode, "GBK"));
        AppZxEqManager2 manager = new AppZxEqManager2();
...
//            zxPostRecordDao.updPostRecord(bean, resStr);
            H bean = XstreamUtils.toBean(resStr, clahh);
            System.out.println("h Bean :" + bean.toString());
