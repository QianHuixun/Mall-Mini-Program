...
import cn.tofocus.lejia.zx.bean.T21000005Request;
import cn.tofocus.lejia.zx.bean.T21000005Response;
import cn.tofocus.lejia.zx.util.HttpsPost;
import cn.tofocus.lejia.zx.util.SignUtil;
import cn.tofocus.lejia.zx.util.Utils;


public class T21000005
{
	/** 根目录*/
    ...
    public static void main(String[] args) {
        ...
        **/
        ...
        try {
            ...
            T21000005Request request = new T21000005Request();
            request.setTRANS_CODE("21000005");
            request.setREQ_SSN("J100364000000002019121715131000012300156");
            request.setMCHNT_ID("J10036400000000");
            request.setUSER_ID("J10036400000001");
            request.setWITH_TYPE("00");
            request.setBUSS_ID("H0000040000000020190415164422363IY692569");
            request.setTRANS_DT("20190416");
            request.setTRANS_TM("150836");
            request.setFEE_TYPE("2");
            request.setWITH_AMT(new BigDecimal(10));
            request.setMEMO("");
            request.setREQ_RESERVED("");
            
            //实体对象转换为XML
            xtreamData.alias("ROOT", T21000005Request.class);
...
//            String resStr = "<?xml version=\"1.0\" encoding=\"utf-8\"?><ROOT><RSP_CODE>00000</RSP_CODE><REQ_SSN>BECP20180327163652919JM296TX4D4ZIY69OQ8K</REQ_SSN><MEM_ID>H00000700000001</MEM_ID><SIGN_INFO></SIGN_INFO></ROOT>";
            resStr = resStr.replace("ROOT", T21000005Response.class.getName());

            //把xml为转换为实体对象
            T21000005Response resData =
                    (T21000005Response) Utils.getObjectFromXML(resStr, T21000005Response.class);
