...
import cn.tofocus.lejia.zx.bean.T21000004Request;
import cn.tofocus.lejia.zx.bean.T21000004Response;
import cn.tofocus.lejia.zx.util.HttpsPost;
import cn.tofocus.lejia.zx.util.SignUtil;
import cn.tofocus.lejia.zx.util.Utils;


public class T21000004
{
	/** 根目录*/
    ...
    public static void main(String[] args) {
        ...
        **/
        ...
        try {
            ...
            T21000004Request request = new T21000004Request();
            request.setTRANS_CODE("21000004");
            request.setREQ_SSN("J100364000000002018121715131000012300156");
        	request.setMCHNT_ID("J10036400000000");
            request.setUSER_D_ID("J10032400000107");
            request.setUSER_D_NM("金划转个人1");
            request.setUSER_C_ID("J10032400000108");
            request.setUSER_C_NM("资金划转个人2");
            request.setBUSS_ID("46546");
            request.setBUSS_SUB_ID("111");
            request.setTRANS_DT("20190420");
            request.setTRANS_TM("122545");
            request.setAMOUNT(new BigDecimal(10));
            request.setFUND_TP("001009");
            request.setCONTRACT_ID("111");
            request.setMEMO("回执");
            request.setREQ_RESERVED("111");
            
            //实体对象转换为XML
            xtreamData.alias("ROOT", T21000004Request.class);
...
//            String resStr = "<?xml version=\"1.0\" encoding=\"utf-8\"?><ROOT><RSP_CODE>00000</RSP_CODE><REQ_SSN>BECP20180327163652919JM296TX4D4ZIY69OQ8K</REQ_SSN><MEM_ID>H00000700000001</MEM_ID><SIGN_INFO></SIGN_INFO></ROOT>";
            resStr = resStr.replace("ROOT", T21000004Response.class.getName());

            //把xml为转换为实体对象
            T21000004Response resData =
                    (T21000004Response) Utils.getObjectFromXML(resStr, T21000004Response.class);
