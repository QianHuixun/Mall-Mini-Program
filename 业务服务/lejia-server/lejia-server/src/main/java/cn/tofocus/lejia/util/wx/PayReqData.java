...
public class PayReqData
{
    ...
    * @param goodsTag 商品标记，微信平台配置的商品标记，用于优惠券或者满减使用 String time_start,String time_expire,
    */
    public PayReqData(int totalFee, String body, String attach, String out_trade_no, String spbill_create_ip,
        String notify_url, String openid, String submch, WeixinConfig wxc)
    {
        
        //微信分配的公众号ID（开通公众号之后可以获取到）
        setAppid(wxc.getAPP_ID());
        
        //微信支付分配的商户号ID（开通公众号的微信支付功能之后可以获取到）
        setMch_id(wxc.getMCH_ID());
        ...
        //   setSub_appid(PackConfigure.getWxappid());
        setSub_mch_id(submch);
        ...
        //订单失效时间，格式同上
        // setTime_expire(this.time_expire);
