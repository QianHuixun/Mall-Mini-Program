...
public class SybPayService
{
    ...
    public Map<String, String> pay(long trxamt, String reqsn, String paytype, String body, String remark, String acct,
        String validtime, String notify_url, String limit_pay, String idno, String truename, String asinfo,
        String sub_appid, String goods_tag, String benefitdetail, String chnlstoreid, String subbranch,
        String extendparams, String cusip, String fqnum)
        throws Exception
    {
        HttpConnectionUtil http = new HttpConnectionUtil(SybConstants.SYB_APIURL + "/pay");
        http.init();
        TreeMap<String, String> params = new TreeMap<String, String>();
        if (!SybUtil.isEmpty(SybConstants.SYB_ORGID)) params.put("orgid", SybConstants.SYB_ORGID);
    ...
    public Map<String, String> cancel(long trxamt, String reqsn, String oldtrxid, String oldreqsn)
        throws Exception
    {
    ...
    public Map<String, String> refund(long trxamt, String reqsn, String oldtrxid, String oldreqsn)
        throws Exception
    {
    ...
    public static Map<String, String> handleResult(String result)
        throws Exception
    {
        System.out.println("ret:" + result);
//        Map map = SybUtil.json2Obj(result, Map.class);
        Map map = JsonUtil.getBean(result, Map.class);
        if (map == null)
        {
    ...
    public Map<String, String> xtPay()
        throws Exception
    {
//        HttpConnectionUtil http = new HttpConnectionUtil(SybConstants.SYB_APIURL + "/pay");
//        http.init();
        ...
        if (!SybUtil.isEmpty(SybConstants.SYB_ORGID)) params.put("orgid", SybConstants.SYB_ORGID);
        params.put("cusid", SybConstants.SYB_CUSID);//61056595    266635
        params.put("appid", SybConstants.SYB_APPID);
        params.put("version", "11");
        params.put("trxamt", String.valueOf("2"));
        params.put("reqsn", "test"+System.currentTimeMillis());
        params.put("paytype", "IM01");// W01   IM01
        params.put("randomstr", SybUtil.getValidatecode(8));
//        params.put("body", body); //标题
//        params.put("remark", remark); //备注
//        params.put("validtime", validtime);
//        params.put("acct", "wxopenid"); //TODO
        params.put("notify_url", "https://cloudtest.xinanshizu.com/zyysc/v1/syb/pay/reurl"); //回调
//        params.put("limit_pay", limit_pay);
//        params.put("sub_appid", "wxe548357850084152");
//        params.put("goods_tag", goods_tag);
//        params.put("benefitdetail", benefitdetail);
//        params.put("chnlstoreid", chnlstoreid);
//        params.put("subbranch", subbranch);
...
//        params.put("idno", idno);
//        params.put("truename", truename);
//        params.put("asinfo", "[{\"splitIdType\": 1,\"splitId\": \"61164686\",\"amount\": 1},{\"splitIdType\": 0,\"amount\": 1}]"); //分账信息
        params.put("asinfo", "[{\"splitIdType\": 1,\"splitId\": \""+ SybConstants.SYB_CUSID + "\",\"amount\": 1},{\"splitIdType\": 0,\"amount\": 1}]"); //分账信息
        params.put("signtype", SybConstants.SIGN_TYPE);
        String appkey = "";
        if (SybConstants.SIGN_TYPE.equals("RSA"))
            appkey = SybConstants.SYB_RSACUSPRIKEY;
            ...
            appkey = SybConstants.SYB_MD5_APPKEY;
        params.put("sign", SybUtil.unionSign(params, appkey, SybConstants.SIGN_TYPE));
        String url = SybConstants.SYB_APIURL + "/pay";
        for(String key : params.keySet())
        {
            multiValueMap.set(key, params.get(key));
        }
        String result = HttpUtil.forString(url).post().body(params).form(multiValueMap).exec();
        
//        String result = HttpUtil.postBodyForString(url, params);
//        byte[] bys = http.postParams(params, true);
//        String result = new String(bys, "UTF-8");
        Map<String, String> map = handleResult(result);
        return map;
