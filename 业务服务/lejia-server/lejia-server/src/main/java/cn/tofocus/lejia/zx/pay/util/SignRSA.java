    ...
    public static String getPriKey(String pwd, String filepathKey)
    {
        ...
        try
        {
            ...
            PrivateKey signerPrivateKey =
                CryptUtil.decryptPrivateKey(decoder.decode(base64EncodedPrivateKey), keyPassword);
    ...
    public static String getPubCer(String filepathCer)
    {
        ...
        try
        {
            ...
            X509Certificate signerCertificate =
                CryptUtil.generateX509Certificate(decoder.decode(base64EncodedSenderCert));
