...
import cn.tofocus.lejia.zx.bean.T21000002Request;
import cn.tofocus.lejia.zx.bean.T21000002Response;
import cn.tofocus.lejia.zx.util.HttpsPost;
import cn.tofocus.lejia.zx.util.SignUtil;
import cn.tofocus.lejia.zx.util.Utils;


public class T21000002
{
	/** 根目录*/
    ...
    public static void main(String[] args) {
        ...
        **/
        ...
        try {
            ...
            T21000002Request request = new T21000002Request();
            request.setTRANS_CODE("21000002");
            request.setREQ_SSN("J100364000000002018121715131000012300051");
            request.setMCHNT_ID("J10036400000000");//平台商户编号             
            request.setUSER_ID("J10036400000001");// 用户编号
            request.setACCT_NM("联调测试");// 账户名称
            request.setPAN("3355669922883377010");// 银行卡号
            request.setPAN_NUM("123456");// 网点联行号
            request.setOP_TYPE("1");// 操作类型
            request.setBANK_PHONE("13812698475");// 银行预留手机号
            request.setREQ_RESERVED("21");// 发起方保留域
            
            //实体对象转换为XML
            xtreamData.alias("ROOT", T21000002Request.class);
...
//            String resStr = "<?xml version=\"1.0\" encoding=\"utf-8\"?><ROOT><RSP_CODE>00000</RSP_CODE><REQ_SSN>BECP20180327163652919JM296TX4D4ZIY69OQ8K</REQ_SSN><MEM_ID>H00000700000001</MEM_ID><SIGN_INFO></SIGN_INFO></ROOT>";
            resStr = resStr.replace("ROOT", T21000002Response.class.getName());

            //把xml为转换为实体对象
            T21000002Response resData =
                    (T21000002Response) Utils.getObjectFromXML(resStr, T21000002Response.class);
