...
public class T21000014
{
    ...
    public static void main(String[] args)
    {
        ...
        try
        {
            ...
            request.setWITH_ACCOUNT("6217730700880774");
            request.setWITH_ACCNAME("在市谋");
            
            //实体对象转换为XML
            xtreamData.alias("ROOT", T21000014Request.class);
            ...
            resStr = resStr.replace("ROOT", T21000014Response.class.getName());
            
          //把xml为转换为实体对象
            T21000014Response resData = (T21000014Response)Utils.getObjectFromXML(resStr, T21000014Response.class);
