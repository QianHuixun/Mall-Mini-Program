...
import cn.tofocus.lejia.zx.bean.T20000011Request;
import cn.tofocus.lejia.zx.bean.T20000011Response;
import cn.tofocus.lejia.zx.util.HttpsPost;
import cn.tofocus.lejia.zx.util.SignUtil;
import cn.tofocus.lejia.zx.util.Utils;

public class T20000011
{
    /** 根目录*/
    ...
    public static void main(String[] args)
    {
        ...
        **/
        ...
        try
        {
            ...
            T20000011Request request = new T20000011Request();
            request.setTRANS_CODE("20000011");
            request.setREQ_SSN("H0000040000000020190424010030280Tsab1qg0");
            request.setMCHNT_ID("H00000400000000");
            request.setFILE_TYPE("HYGJ");
            request.setSETTLE_DT("20190507");
            
            //实体对象转换为XML
            xtreamData.alias("ROOT", T20000011Request.class);
            ...
            resStr = resStr.replace("ROOT", T20000011Response.class.getName());
            
            //把xml为转换为实体对象
            T20000011Response resData = (T20000011Response)Utils.getObjectFromXML(resStr, T20000011Response.class);
