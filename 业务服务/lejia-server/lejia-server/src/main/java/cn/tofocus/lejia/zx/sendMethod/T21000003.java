...
//        String httpsUrl = "https://22.5.227.200:30466/dsgj/";
        ...
        try {
            ...
            Random r = new Random();
            String reqSsn = "J00024000000000" + DateUtil.formatDate(new Date(), "yyyyMMddHHmmssSSS")
                + String.valueOf(r.nextLong()).substring(1, 8 + 1);
            request.setREQ_SSN(reqSsn);
            request.setMCHNT_ID("J00024000000000");//平台商户编号             
            request.setUSER_ID("J00024000000004");// 用户编号
            request.setUSER_NM("慈增修");//用户变更姓名
            request.setUSER_CARD_TP("01");//用户证件类型
        	request.setUSER_CARD_NO("411681199001178484");//用户证件号码
        	request.setUSER_PHONE("15169999004");//用户手机号
//        	request.setUSER_ADD("北京市青年路");//用户地址
//        	request.setCORP_NM("");//企业法人姓名
//        	request.setCORP_ID_TYPE("");//企业法人身份证号码
        	request.setUSER_ROLE("001001");//用户角色
//        	request.setREQ_RESERVED("");//发起方保留域
            
            //实体对象转换为XML
            xtreamData.alias("ROOT", T21000003Request.class);
...
//            String resStr = "<?xml version=\"1.0\" encoding=\"utf-8\"?><ROOT><RSP_CODE>00000</RSP_CODE><REQ_SSN>BECP20180327163652919JM296TX4D4ZIY69OQ8K</REQ_SSN><MEM_ID>H00000700000001</MEM_ID><SIGN_INFO></SIGN_INFO></ROOT>";
            resStr = resStr.replace("ROOT", T21000003Response.class.getName());

            //把xml为转换为实体对象
            T21000003Response resData =
                    (T21000003Response) Utils.getObjectFromXML(resStr, T21000003Response.class);
