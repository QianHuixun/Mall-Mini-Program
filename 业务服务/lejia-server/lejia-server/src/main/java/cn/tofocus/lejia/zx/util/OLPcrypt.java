...
public class OLPcrypt {
	...
	//加签
	public static String sign(byte[] byte_明文报文, String 发送方私钥文件密码,
	...
	public static void main(String[] args) throws UnsupportedEncodingException,
		...
		try {
			...
			String xmlStr = "<?xml version=\"1.0\" encoding=\"GBK\"?><ROOT><sysname>PAFDSF</sysname><trancode>DSF01</trancode><trantype>S</trantype><trandate>20160728</trandate><trantime>191826</trantime><batchnum>201607283514</batchnum><reqfilename>citicnds20160728201607283514</reqfilename><transumamt>400</transumamt><transumrecd>400</transumrecd><filedigestalg>MD5</filedigestalg><filedigest>0519f5b5852a0d2be967c523c46ac991</filedigest></ROOT>";
			byte[] strByte = xmlStr.getBytes();
			byte[] msg = xmlStr.getBytes(encode);
			// 加签
			String signByte = OLPcrypt.sign(msg, "Mima001",
					"D:\\gitclone\\lejia-server\\lejia-server\\PTNR\\PTNRtest.key",
					"D:\\gitclone\\lejia-server\\lejia-server\\PTNR\\PTNRtest.cer");
			byte[] signedMsg = LinkByteArrays(
					("<signature>" + signByte + "</signature>").getBytes(),
					strByte); // 带签名的报文
			System.out.println("===========>>>  "
					+ new String(signedMsg, encode));
