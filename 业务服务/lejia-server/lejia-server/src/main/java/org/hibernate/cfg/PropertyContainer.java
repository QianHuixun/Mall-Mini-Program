...
//        (CoreMessageLogger)Logger.getMessageLogger(CoreMessageLogger.class, PropertyContainer.class.getName());
//    
...
//            localClassLevelAccessType != AccessType.DEFAULT ? localClassLevelAccessType : defaultClassLevelAccessType;
//        
...
//                        LOG.ambiguousPropertyMethods(this.xClass.getName(),
//                            HCANNHelper.annotatedElementSignature(previous),
//                            HCANNHelper.annotatedElementSignature(xProperty)),
//                        new Origin(SourceType.ANNOTATION, this.xClass.getName()));
//                }
//                
...
//        
//        String msg = "Property " + StringHelper.qualify(this.xClass.getName(), xProperty.getName())
...
//            (org.hibernate.annotations.AccessType)this.xClass.getAnnotation(org.hibernate.annotations.AccessType.class);
//        if (accessType != null)
//        {
...
//            && !((ManyToOne)p.getAnnotation(ManyToOne.class)).targetEntity().equals(Void.TYPE))
//        {
//            return true;
//        }
