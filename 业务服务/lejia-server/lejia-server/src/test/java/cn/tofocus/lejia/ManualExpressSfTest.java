...
public class ManualExpressSfTest
{
    private final String baseUrl = "https://butler-ms.sf-express.com";
    
    private final String appId = "1019015320171839488";
    
    private final String sk = "baa430959012bfcae9100d6b556a6dd3";
    
    private final String monthlyCard = "0226047324";

    // 订单号
    private final String expressNo = "T2024121900001";
    ...
    private final String senderProvince = "天津市";
    
    private final String senderCity = "天津市";
    
    private final String senderAddress = "天津市滨海新区解放路536号新天地购物广场3层长虹百货";
    ...
    private final String receiverProvince = "浙江省";
    
    private final String receiverCity = "温州市";
    
    private final String receiverAddress = "浙江省温州市瓯海区梧田街道国家大学科技园1号楼702";

    // 寄件参数
    private final String pickupTime = "";

    private final String sendContent = "文件";
    
    private final BigDecimal sendWeight = BigDecimal.ONE.setScale(3, RoundingMode.HALF_UP);

    private final Integer sendNum = 1;
     ...
     */
    @Test
    public void getFreightAddedServices()
    {
        ...
        System.out.println("[顺丰快递] 运费估算接口（含增值服务）请求参数: " + json);
        ...
        System.out.println("[顺丰快递] 运费估算接口（含增值服务）响应参数: " + JsonUtil.toString(result));
        if (!result.isSuccess())
    ...
    public void placeOrder()
    {
        ...
        json.put("sendStartTime", pickupTime); //可空、上门取件时间
    ...
    public void cancelOrder()
    {
        ...
        HttpHeaders headers = getHeads(appId, sk, json.toString());
        System.out.println("[顺丰快递] 订单取消请求参数: " + json);
        ...
        System.out.println("[顺丰快递] 订单取消响应参数: " + JsonUtil.toString(result));
        if (!result.isSuccess())
