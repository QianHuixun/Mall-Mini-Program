<template>
  <div class="gzh-rider">
    <img src="../../assets/images/rider_message.jpg" alt="" @click="handleGetAgain">
    <!-- <div class="font-content" @click="getOpenid">
      <div class="tips">{{openid}}</div>
    </div> -->
  </div>
...
export default {
  ...
  methods: {
    logClick() {
      ...
      axios.post(api.gzh.bindOpenid, this.$qs.stringify(params)).then((res) => {
