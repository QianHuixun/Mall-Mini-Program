 ...
 * @LastEditors: 沙晓
 * @LastEditTime: 2025-06-17 15:29:31
 * @Description: 账户信息
 * @FilePath: /lejia-web/src/views/vendor/sub/merchant/accountInfoComp.vue
-->
<template>
...
export default {
  ...
  methods: {
    ...
    getData(pkey) {
      ...
      axios
        .post(api.market.financeVendorInfoGet, qs.stringify(params), {
          headers: {
    ...
    submit: function() {
      ...
      this.loading = true;
      axios.post(api.market.financeVendorInfoUpd, param, {
          headers: {
            Authorization: this.$store.state.token,
          },
        })
