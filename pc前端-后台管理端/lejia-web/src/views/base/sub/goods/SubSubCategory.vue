  ...
  <div class="table-container">
    ...
    <div class="search-box">
      ...
      <div class="search-box-form">
        ...
        <el-cascader v-model="goodsType" :options="typeList" clearable :props="props" @change="handleGoodsTypeChange" placeholder="商品分类">
        </el-cascader>
    ...
    element-loading-spinner="el-icon-loading"  border style="width: 100%" >
        ...
        <el-table-column label="二级分类" prop="twoGtypeName"></el-table-column>
...
export default {
  ...
  methods: {
     ...
     */
    handelAdd: function () {
      this.$refs.AddComp.show('three');
    },
    /**
     * 点击修改
     */
    handleEdit: function (row) {
      this.$refs.EditComp.show({ row: row, type: 'three' });
    },
    /**
     * 删除公司
     */
    handleDelete: function (row) {
      ...
      axios
        .post(api.mall.delThreeGoods, qs.stringify(params), {
          headers: {
    ...
    handleStatus: function (status, pkey) {
      ...
      if (status) {
        url = api.mall.startThreeGoods;
        text = '启用';
      } else {
        url = api.mall.stopThreeGoods;
        text = '停用';
      }
      axios
    ...
    getData: function () {
      ...
      const params = {
        ...
        twoGtype: this.twoGtype,
      };
      params[this.searchKey] = this.keywords;
      axios
        .post(api.mall.queryThreeGoodsList, qs.stringify(params), {
          headers: {
            Authorization: this.$store.state.token,
          },
        })
    ...
    async handleImport(file) {
      ...
      axios
        .post(api.mall.importThreeGoods, params, {
          headers: {
    ...
    handleDownload: function () {
      console.log(api.mall.downThreeGoods);
      location.href = api.mall.downThreeGoods;
    },
  },
};
</script>