...
!-->
<template lang="html">
  <el-dialog title="添加优惠券" :visible.sync="visible" :closeOnClickModal="false" width="1500px"
    ...
    <div class="table-container">
      ...
      <div class="table-box">
        <el-table ref="multipleTable" :data="tableData" :loading="loading" border style="width: 100%"
          ...
          <el-table-column label="订单金额" prop="limitCost"></el-table-column>
  ...
  export default {
    ...
    methods: {
      ...
      getData: function () {
        ...
        /**获取表格数据 */
        axios.post(api.marketing.queryCoupon, qs.stringify(params), {
            headers: {
