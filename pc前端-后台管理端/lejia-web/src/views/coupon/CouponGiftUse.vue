  ...
  <div class="table-container">
    ...
    <div class="table-box">
      <el-table :data="tableData" :loading="loading" border style="width: 100%">
        <el-table-column label="卡券名称" prop="giftTitle" min-width="150"></el-table-column>
        ...
        <el-table-column label="使用市场" prop="userFarmerName" min-width="150">
          <template slot-scope="scope">
            {{ scope.row.userFarmerName || '--' }}
          </template>
        </el-table-column>
  ...
  export default {
    ...
    startSearch: function ({ key, keywords }) {
      ...
      getData: function () {
        ...
        axios.post(api.marketing.useGiftCoupon, qs.stringify(params), {
            headers: {
      ...
      getNumData: function(){
        ...
        params[this.searchKey] = this.keywords;
        axios.post(api.marketing.useGiftSum, qs.stringify(params), {
            headers: {
              Authorization: this.$store.state.token
            }
          })
      ...
      handleImportExcel() {
        ...
        axios
          .post(api.marketing.useGiftCouponExport, qs.stringify(params), {
            headers: {
              Authorization: this.$store.state.token,
            },
            responseType: 'blob',
