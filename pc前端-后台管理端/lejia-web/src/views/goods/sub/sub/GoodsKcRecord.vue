<!-- 
@name: GoodsKcRecord.vue 
@description: 库存管理-采购入库
@author: crj
@date: 2020/09/27
-->
<template>
  <el-dialog title="采购入库" center :visible.sync="visible" :closeOnClickModal="false" width="850px"
    ...
    <el-form>
      ...
      <el-form-item label="规格" :label-width="labelWidth" :required="true">
        <el-select v-model="inputModel.space" placeholder="请选择">
          <el-option v-for="(item,index) in spaceList" :key="index" :label="item.spaceName" :value="item.space">
          </el-option>
        </el-select>
      </el-form-item>
      <el-form-item label="批次号" :label-width="labelWidth" :required="true">
        <el-input v-model="inputModel.orderNumber" ref="orderNumberInput" placeholder="请输入批次号"></el-input>
      </el-form-item>
      <el-form-item label="采购价" :label-width="labelWidth" :required="true" >
        <el-input v-model="inputModel.price" ref="priceInput" placeholder="请输入采购价" type="number" @mousewheel.native.prevent></el-input>
      </el-form-item>
      <el-form-item label="数量" :label-width="labelWidth" :required="true">
        <el-input v-model="inputModel.num" ref="numInput" placeholder="请输入数量" v-on:input="limitInput($event) "></el-input>
      </el-form-item>
      <el-form-item label="供应商" :label-width="labelWidth" :required="true">
        <el-input v-model="inputModel.supplier" ref="supplierInput" placeholder="请输入供应商"></el-input>
      </el-form-item>
    ...
    methods: {
     limitInput(val){
      ...
      initData(goodsData) {
        ...
        inputModel.wareType = 'WAREHOUSING';
