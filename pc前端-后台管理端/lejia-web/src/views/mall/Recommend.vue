  ...
  <div class="table-container">
    ...
    <div class="search-box">
      ...
      <div class="search-box-form">
        ...
        <el-select v-model="searchData.zone" filterable clearable placeholder="推荐区域"  @change="handleChange">
          <el-option label="首页" value="HOME_PAGE"></el-option>
          <el-option label="限时秒杀" value="SPECIAL"></el-option>
          <el-option label="分类" value="CATEGORY"></el-option>
          <el-option label="商品详情" value="GOODS_DETAIL"></el-option>
          <el-option label="购物车" value="GWC"></el-option>
    ...
    <div class="table-box">
      <el-table :data="tableData" :loading="loading" border style="width: 100%" >
        ...
        <el-table-column label="商户" prop="ownerName" show-overflow-tooltip></el-table-column>
        ...
        <el-table-column label="推荐区域" prop="zoneNames" show-overflow-tooltip width="300px"></el-table-column>
...
<script>
import AddComp from './RecommendComp/add.vue'
import EditComp from './RecommendComp/edit.vue'
export default {
  data() {
    return {
      loading: false,
