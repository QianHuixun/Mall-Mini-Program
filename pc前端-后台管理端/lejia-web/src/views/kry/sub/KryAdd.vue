<!-- 
@name: KryAdd.vue 
@description: 客如云商户管理 -- 新增组件 
@author: sx
@date: 2020/07/13
-->
<template lang="html">
  <update-comp :title="'新增客如云商户'" ref="updateComp" @confirm="handleUpdate" @hide="hide"></update-comp>
</template>
<script>
...
export default {
  ...
  methods: {
    ...
    handleUpdate: function({ inputModel }) {
      ...
      axios.post(api.market.insKru, qs.stringify(params), {
          headers: {
