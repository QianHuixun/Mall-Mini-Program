...
@Data
@Component
@ConfigurationProperties(prefix = "tofocus.file.ue")
public class UeConfig
{
    private static final String fileParam = "upfile";
    ...
    private String imageFieldName = fileParam; /* 提交的图片表单名称 */
    ...
    //没用
    private String localSavePathPrefix = "/data/resources/";
    
    //没用
    private String imagePathFormat = "/uploads/image/{yyyy}{mm}{dd}/{time}{rand:6}"; /* 上传保存路径,可以自定义保存路径和文件名格式 */
    ...
    private String scrawlFieldName = fileParam; /* 提交的图片表单名称 */
    ...
    private String videoFieldName = fileParam; /* 提交的视频表单名称 */
    
    private String videoPathFormat =
        "/ueditor/jsp/upload/video/{yyyy}{mm}{dd}/{time}{rand:6}"; /* 上传保存路径,可以自定义保存路径和文件名格式 */
    ...
    private String fileFieldName = fileParam; /* 提交的文件表单名称 */
    
    private String filePathFormat =
        "/ueditor/jsp/upload/file/{yyyy}{mm}{dd}/{time}{rand:6}"; /* 上传保存路径,可以自定义保存路径和文件名格式 */
    ...
    private String[] fileAllowFiles = new String[] {".png", ".jpg", ".jpeg", ".gif", ".bmp", ".flv", ".swf", ".mkv",
        ...
        ".mid", ".rar", ".zip", ".tar", ".gz", ".7z", ".bz2", ".cab", ".iso", ".doc", ".docx", ".xls", ".xlsx", ".ppt",
    ...
    private String[] fileManagerAllowFiles = new String[] {".png", ".jpg", ".jpeg", ".gif", ".bmp", ".flv", ".swf",
        ...
        ".wav", ".mid", ".rar", ".zip", ".tar", ".gz", ".7z", ".bz2", ".cab", ".iso", ".doc", ".docx", ".xls", ".xlsx",
        ".ppt", ".pptx", ".pdf", ".txt", ".md", ".xml"}; /* 列出的文件类型 */
    
    public boolean checkImgExt(String ext)
    {
        for (String s : imageAllowFiles)
        {
            if (s.substring(1).equals(ext.toLowerCase()))
                return true;
        }
        return false;
    }
