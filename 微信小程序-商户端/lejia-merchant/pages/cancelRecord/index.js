...
Page({
    ...
    http.request({
      ...
      success: function (res) {
        ...
        if (res.data.success) {
          ...
          let result = res.data;
          result.result = res.data.result.content;
  ...
  getSumData(){
    ...
    http.request({
      method: "POST",
      url: app.globalData.ajax_url + '/v1/app/vendor/gift/sumAmtn',
      data: params,
      header: {
        "Content-Type": 'application/x-www-form-urlencoded',
        "openid": app.globalData.openid
      ...
      success: function (res) {
        ...
        if (res.data.success) {
          that.setData({
            sumData: res.data.result?res.data.result:0,
          })
